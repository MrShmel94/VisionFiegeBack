...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
    ...
    @Query("""
        SELECT new com.example.ws.microservices.firstmicroservices.dto.SupervisorAllInformationDTO(
            ...
            ai.note, ai.dateStartContract, ai.dateFinishContract, ai.dateBhpNow, ai.dateBhpFuture,
        ...
        WHERE ur.expertis = :expertis OR ur.userId = :expertis
    """)
    Optional<SupervisorAllInformationDTO> findByExpertis(@Param("expertis") String expertis);
